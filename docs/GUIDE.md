...
> **Welcome to Product-Track Week 7, Task 6!**
...
| `src/canaryAnalyzer.js` | Main source code - **has bugs to fix** |
| `src/trafficSplitter.js` | Supporting code - **may also have bugs** |
| `tests/trafficSplitter.test.js` | Test file - **add your tests here** |
